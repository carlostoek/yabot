# modulos-atomicos - Task 6

Execute task 6 for the modulos-atomicos specification.

## Task Description
Extend users collection schema in src/database/schemas/mongo.py

## Code Reuse
**Leverage existing code**: Existing users schema structure

## Requirements Reference
**Requirements**: 1.2, 2.1, 3.1, 6.2

## Usage
```
/Task:6-modulos-atomicos
```

## Instructions

Execute with @spec-task-executor agent the following task: "Extend users collection schema in src/database/schemas/mongo.py"

```
Use the @spec-task-executor agent to implement task 6: "Extend users collection schema in src/database/schemas/mongo.py" for the modulos-atomicos specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Extend users collection schema in src/database/schemas/mongo.py
- Leverage: Existing users schema structure
- Requirements: 1.2, 2.1, 3.1, 6.2

## Instructions
- Implement ONLY task 6: "Extend users collection schema in src/database/schemas/mongo.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulos-atomicos 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulos-atomicos 6 --mode complete
```
