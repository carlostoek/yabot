# modulos-atomicos - Task 21

Execute task 21 for the modulos-atomicos specification.

## Task Description
Create subscription manager in src/modules/admin/subscription_manager.py

## Code Reuse
**Leverage existing code**: src/services/subscription.py patterns
...
## Usage
```
/Task:21-modulos-atomicos
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create subscription manager in src/modules/admin/subscription_manager.py"

```
Use the @spec-task-executor agent to implement task 21: "Create subscription manager in src/modules/admin/subscription_manager.py" for the modulos-atomicos specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Create subscription manager in src/modules/admin/subscription_manager.py
- Leverage: src/services/subscription.py patterns
- Requirements: 3.2, 5.1

## Instructions
- Implement ONLY task 21: "Create subscription manager in src/modules/admin/subscription_manager.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulos-atomicos 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulos-atomicos 21 --mode complete
```
