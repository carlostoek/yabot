...
Execute task 3 for the fase1 specification.

## Task Description
Update .env.example with new infrastructure environment variables

## Code Reuse
**Leverage existing code**: .env.example (existing environment variable patterns)
...
Execute with @spec-task-executor agent the following task: "Update .env.example with new infrastructure environment variables"

```
Use the @spec-task-executor agent to implement task 3: "Update .env.example with new infrastructure environment variables" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Update .env.example with new infrastructure environment variables
- Leverage: .env.example (existing environment variable patterns)
- Requirements: 5.2

## Instructions
- Implement ONLY task 3: "Update .env.example with new infrastructure environment variables"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 3 --mode complete
```
