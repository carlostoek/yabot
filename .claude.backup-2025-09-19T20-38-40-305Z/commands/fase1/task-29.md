...
Execute task 29 for the fase1 specification.

## Task Description
Enhance Router with database context in src/core/router.py

## Code Reuse
**Leverage existing code**: src/core/router.py, src/services/user.py
...
Execute with @spec-task-executor agent the following task: "Enhance Router with database context in src/core/router.py"

```
Use the @spec-task-executor agent to implement task 29: "Enhance Router with database context in src/core/router.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 29
- Description: Enhance Router with database context in src/core/router.py
- Leverage: src/core/router.py, src/services/user.py
- Requirements: 5.1

## Instructions
- Implement ONLY task 29: "Enhance Router with database context in src/core/router.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 29 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 29 --mode complete
```
