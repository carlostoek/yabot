...
Execute task 12 for the fase1 specification.

## Task Description
Create base event models in src/events/models.py
...
Execute with @spec-task-executor agent the following task: "Create base event models in src/events/models.py"

```
Use the @spec-task-executor agent to implement task 12: "Create base event models in src/events/models.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Create base event models in src/events/models.py
- Leverage: src/core/models.py (existing Pydantic patterns)
- Requirements: 2.2

## Instructions
- Implement ONLY task 12: "Create base event models in src/events/models.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 12 --mode complete
```
