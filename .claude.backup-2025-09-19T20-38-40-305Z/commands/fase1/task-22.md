...
Execute task 22 for the fase1 specification.

## Task Description
Create JWT authentication service in src/api/auth.py

## Code Reuse
**Leverage existing code**: src/config/manager.py, src/utils/logger.py
...
Execute with @spec-task-executor agent the following task: "Create JWT authentication service in src/api/auth.py"

```
Use the @spec-task-executor agent to implement task 22: "Create JWT authentication service in src/api/auth.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create JWT authentication service in src/api/auth.py
- Leverage: src/config/manager.py, src/utils/logger.py
- Requirements: 4.3

## Instructions
- Implement ONLY task 22: "Create JWT authentication service in src/api/auth.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 22 --mode complete
```
