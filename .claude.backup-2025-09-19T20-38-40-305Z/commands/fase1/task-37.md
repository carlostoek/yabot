...
Execute task 37 for the fase1 specification.

## Task Description
Create DatabaseManager unit tests in tests/database/test_manager.py

## Code Reuse
**Leverage existing code**: tests/utils/database.py
...
Execute with @spec-task-executor agent the following task: "Create DatabaseManager unit tests in tests/database/test_manager.py"

```
Use the @spec-task-executor agent to implement task 37: "Create DatabaseManager unit tests in tests/database/test_manager.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 37
- Description: Create DatabaseManager unit tests in tests/database/test_manager.py
- Leverage: tests/utils/database.py
- Requirements: 1.1

## Instructions
- Implement ONLY task 37: "Create DatabaseManager unit tests in tests/database/test_manager.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 37 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 37 --mode complete
```
