...
Execute task 20 for the fase1 specification.

## Task Description
Create event ordering buffer in src/events/ordering.py

## Code Reuse
**Leverage existing code**: src/events/models.py, src/utils/logger.py
...
Execute with @spec-task-executor agent the following task: "Create event ordering buffer in src/events/ordering.py"

```
Use the @spec-task-executor agent to implement task 20: "Create event ordering buffer in src/events/ordering.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create event ordering buffer in src/events/ordering.py
- Leverage: src/events/models.py, src/utils/logger.py
- Requirements: 3.2

## Instructions
- Implement ONLY task 20: "Create event ordering buffer in src/events/ordering.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 20 --mode complete
```
