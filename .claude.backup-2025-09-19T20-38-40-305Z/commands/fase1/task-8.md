...
Execute task 8 for the fase1 specification.

## Task Description
Create MongoDB schema definitions in src/database/schemas/mongo.py

## Code Reuse
**Leverage existing code**: src/core/models.py (existing Pydantic patterns)
...
Execute with @spec-task-executor agent the following task: "Create MongoDB schema definitions in src/database/schemas/mongo.py"

```
Use the @spec-task-executor agent to implement task 8: "Create MongoDB schema definitions in src/database/schemas/mongo.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: Create MongoDB schema definitions in src/database/schemas/mongo.py
- Leverage: src/core/models.py (existing Pydantic patterns)
- Requirements: 1.2

## Instructions
- Implement ONLY task 8: "Create MongoDB schema definitions in src/database/schemas/mongo.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 8 --mode complete
```
