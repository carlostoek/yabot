...
Execute task 34 for the fase1 specification.

## Task Description
Create database test utilities in tests/utils/database.py

## Code Reuse
**Leverage existing code**: tests/conftest.py (existing test patterns)
...
Execute with @spec-task-executor agent the following task: "Create database test utilities in tests/utils/database.py"

```
Use the @spec-task-executor agent to implement task 34: "Create database test utilities in tests/utils/database.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: Create database test utilities in tests/utils/database.py
- Leverage: tests/conftest.py (existing test patterns)
- Requirements: Testing Strategy

## Instructions
- Implement ONLY task 34: "Create database test utilities in tests/utils/database.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 34 --mode complete
```
