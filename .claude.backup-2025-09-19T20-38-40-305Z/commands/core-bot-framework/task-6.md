# core-bot-framework - Task 6

Execute task 6 for the core-bot-framework specification.

## Task Description
Create middleware manager in src/core/middleware.py
...
## Usage
```
/Task:6-core-bot-framework
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create middleware manager in src/core/middleware.py"

```
Use the @spec-task-executor agent to implement task 6: "Create middleware manager in src/core/middleware.py" for the core-bot-framework specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Create middleware manager in src/core/middleware.py
- Requirements: 5.4

## Instructions
- Implement ONLY task 6: "Create middleware manager in src/core/middleware.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks core-bot-framework 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks core-bot-framework 6 --mode complete
```
