# core-bot-framework - Task 21

Execute task 21 for the core-bot-framework specification.
...
## Usage
```
/Task:21-core-bot-framework
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create basic documentation in README.md"

```
Use the @spec-task-executor agent to implement task 21: "Create basic documentation in README.md" for the core-bot-framework specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Create basic documentation in README.md
- Requirements: All

## Instructions
- Implement ONLY task 21: "Create basic documentation in README.md"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks core-bot-framework 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks core-bot-framework 21 --mode complete
```
