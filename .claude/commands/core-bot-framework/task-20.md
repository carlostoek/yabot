# core-bot-framework - Task 20

Execute task 20 for the core-bot-framework specification.

## Task Description
Create environment configuration template in .env.example
...
## Usage
```
/Task:20-core-bot-framework
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create environment configuration template in .env.example"

```
Use the @spec-task-executor agent to implement task 20: "Create environment configuration template in .env.example" for the core-bot-framework specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create environment configuration template in .env.example
- Requirements: 1.1, 3.1

## Instructions
- Implement ONLY task 20: "Create environment configuration template in .env.example"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks core-bot-framework 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks core-bot-framework 20 --mode complete
```
