# core-bot-framework - Task 14

Execute task 14 for the core-bot-framework specification.

## Task Description
Create test configuration in tests/conftest.py
...
## Usage
```
/Task:14-core-bot-framework
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create test configuration in tests/conftest.py"

```
Use the @spec-task-executor agent to implement task 14: "Create test configuration in tests/conftest.py" for the core-bot-framework specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create test configuration in tests/conftest.py
- Requirements: All

## Instructions
- Implement ONLY task 14: "Create test configuration in tests/conftest.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks core-bot-framework 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks core-bot-framework 14 --mode complete
```
