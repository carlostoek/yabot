# core-bot-framework - Task 17

Execute task 17 for the core-bot-framework specification.

## Task Description
Create router tests in tests/test_router.py
...
## Usage
```
/Task:17-core-bot-framework
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create router tests in tests/test_router.py"

```
Use the @spec-task-executor agent to implement task 17: "Create router tests in tests/test_router.py" for the core-bot-framework specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Create router tests in tests/test_router.py
- Requirements: 5.1, 5.2

## Instructions
- Implement ONLY task 17: "Create router tests in tests/test_router.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks core-bot-framework 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks core-bot-framework 17 --mode complete
```
