...
Execute task 6 for the ui specification.

## Task Description
Add level unlocking method to LevelProgressionService

## Code Reuse
**Leverage existing code**: src/events/bus.py event publishing patterns
...
Execute with @spec-task-executor agent the following task: "Add level unlocking method to LevelProgressionService"

```
Use the @spec-task-executor agent to implement task 6: "Add level unlocking method to LevelProgressionService" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Add level unlocking method to LevelProgressionService
- Leverage: src/events/bus.py event publishing patterns
- Requirements: 5.1, 5.5

## Instructions
- Implement ONLY task 6: "Add level unlocking method to LevelProgressionService"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 6 --mode complete
```
