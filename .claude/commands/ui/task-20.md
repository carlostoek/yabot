...
Execute task 20 for the ui specification.

## Task Description
Add level progression event listener to EventProcessor

## Code Reuse
**Leverage existing code**: src/events/processor.py existing event listener patterns
...
Execute with @spec-task-executor agent the following task: "Add level progression event listener to EventProcessor"

```
Use the @spec-task-executor agent to implement task 20: "Add level progression event listener to EventProcessor" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Add level progression event listener to EventProcessor
- Leverage: src/events/processor.py existing event listener patterns
- Requirements: 6.1, 6.2

## Instructions
- Implement ONLY task 20: "Add level progression event listener to EventProcessor"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 20 --mode complete
```
