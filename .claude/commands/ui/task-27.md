...
Execute task 27 for the ui specification.

## Task Description
Create pista purchase atomicity test

## Code Reuse
**Leverage existing code**: tests/integration/ existing transaction test patterns
...
Execute with @spec-task-executor agent the following task: "Create pista purchase atomicity test"

```
Use the @spec-task-executor agent to implement task 27: "Create pista purchase atomicity test" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Create pista purchase atomicity test
- Leverage: tests/integration/ existing transaction test patterns
- Requirements: 4.3

## Instructions
- Implement ONLY task 27: "Create pista purchase atomicity test"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 27 --mode complete
```
