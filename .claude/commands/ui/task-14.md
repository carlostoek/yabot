...
Execute task 14 for the ui specification.

## Task Description
Create PistaShopHandler class for purchase interface

## Code Reuse
**Leverage existing code**: src/handlers/commands.py callback handler patterns
...
Execute with @spec-task-executor agent the following task: "Create PistaShopHandler class for purchase interface"

```
Use the @spec-task-executor agent to implement task 14: "Create PistaShopHandler class for purchase interface" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create PistaShopHandler class for purchase interface
- Leverage: src/handlers/commands.py callback handler patterns
- Requirements: 4.1

## Instructions
- Implement ONLY task 14: "Create PistaShopHandler class for purchase interface"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 14 --mode complete
```
