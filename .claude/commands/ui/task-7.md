...
Execute task 7 for the ui specification.

## Task Description
Create basic PistaShop service class
...
Execute with @spec-task-executor agent the following task: "Create basic PistaShop service class"

```
Use the @spec-task-executor agent to implement task 7: "Create basic PistaShop service class" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create basic PistaShop service class
- Leverage: src/modules/gamification/besitos
- Requirements: 4.1, 4.2

## Instructions
- Implement ONLY task 7: "Create basic PistaShop service class"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 7 --mode complete
```
