...
Execute task 1 for the ui specification.

## Task Description
Add narrative_level field to user schema

## Code Reuse
**Leverage existing code**: src/database/schemas/users.py existing user schema patterns
...
Execute with @spec-task-executor agent the following task: "Add narrative_level field to user schema"

```
Use the @spec-task-executor agent to implement task 1: "Add narrative_level field to user schema" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 1
- Description: Add narrative_level field to user schema
- Leverage: src/database/schemas/users.py existing user schema patterns
- Requirements: 5.2

## Instructions
- Implement ONLY task 1: "Add narrative_level field to user schema"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 1 --mode complete
```
