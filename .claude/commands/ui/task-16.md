...
Execute task 16 for the ui specification.

## Task Description
Create LevelProgressionHandler for celebrations

## Code Reuse
**Leverage existing code**: src/handlers/commands.py message formatting patterns
...
Execute with @spec-task-executor agent the following task: "Create LevelProgressionHandler for celebrations"

```
Use the @spec-task-executor agent to implement task 16: "Create LevelProgressionHandler for celebrations" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: Create LevelProgressionHandler for celebrations
- Leverage: src/handlers/commands.py message formatting patterns
- Requirements: 5.4

## Instructions
- Implement ONLY task 16: "Create LevelProgressionHandler for celebrations"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 16 --mode complete
```
