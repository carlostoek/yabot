...
Execute task 2 for the ui specification.

## Task Description
Create LevelProgressionEvent model in events module

## Code Reuse
**Leverage existing code**: src/events/models.py existing BaseEvent patterns
...
Execute with @spec-task-executor agent the following task: "Create LevelProgressionEvent model in events module"

```
Use the @spec-task-executor agent to implement task 2: "Create LevelProgressionEvent model in events module" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: Create LevelProgressionEvent model in events module
- Leverage: src/events/models.py existing BaseEvent patterns
- Requirements: 5.5

## Instructions
- Implement ONLY task 2: "Create LevelProgressionEvent model in events module"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 2 --mode complete
```
