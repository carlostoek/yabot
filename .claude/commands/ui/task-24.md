...
Execute task 24 for the ui specification.

## Task Description
Add besitos transaction recovery to BesitosWallet

## Code Reuse
**Leverage existing code**: src/modules/gamification/besitos
...
Execute with @spec-task-executor agent the following task: "Add besitos transaction recovery to BesitosWallet"

```
Use the @spec-task-executor agent to implement task 24: "Add besitos transaction recovery to BesitosWallet" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Add besitos transaction recovery to BesitosWallet
- Leverage: src/modules/gamification/besitos
- Requirements: 3.5

## Instructions
- Implement ONLY task 24: "Add besitos transaction recovery to BesitosWallet"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 24 --mode complete
```
