...
Execute task 22 for the ui specification.

## Task Description
Create level progression validation module

## Code Reuse
**Leverage existing code**: existing validation patterns in codebase
...
Execute with @spec-task-executor agent the following task: "Create level progression validation module"

```
Use the @spec-task-executor agent to implement task 22: "Create level progression validation module" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create level progression validation module
- Leverage: existing validation patterns in codebase
- Requirements: 1.5, 4.2, 5.1

## Instructions
- Implement ONLY task 22: "Create level progression validation module"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 22 --mode complete
```
