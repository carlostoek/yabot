...
Execute task 11 for the ui specification.

## Task Description
Integrate mission completion in ReactionDetector
...
Execute with @spec-task-executor agent the following task: "Integrate mission completion in ReactionDetector"

```
Use the @spec-task-executor agent to implement task 11: "Integrate mission completion in ReactionDetector" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: Integrate mission completion in ReactionDetector
- Leverage: src/modules/gamification/mission
- Requirements: 2.4, 2.5

## Instructions
- Implement ONLY task 11: "Integrate mission completion in ReactionDetector"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 11 --mode complete
```
