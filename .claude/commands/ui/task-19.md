...
Execute task 19 for the ui specification.

## Task Description
Add Level 2 pista definition to HintSystem

## Code Reuse
**Leverage existing code**: src/modules/narrative/hint
...
Execute with @spec-task-executor agent the following task: "Add Level 2 pista definition to HintSystem"

```
Use the @spec-task-executor agent to implement task 19: "Add Level 2 pista definition to HintSystem" for the ui specification and include all the below context.
...
## Task Details
- Task ID: 19
- Description: Add Level 2 pista definition to HintSystem
- Leverage: src/modules/narrative/hint
- Requirements: 4.4, 4.5

## Instructions
- Implement ONLY task 19: "Add Level 2 pista definition to HintSystem"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui 19 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui 19 --mode complete
```
