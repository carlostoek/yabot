...
Execute task 6 for the fase1 specification.

## Task Description
b. Add collection access methods to MongoDB handler in src/database/mongodb.py

## Code Reuse
**Leverage existing code**: existing connection pooling, src/utils/logger.py
...
Execute with @spec-task-executor agent the following task: "b. Add collection access methods to MongoDB handler in src/database/mongodb.py"

```
Use the @spec-task-executor agent to implement task 6: "b. Add collection access methods to MongoDB handler in src/database/mongodb.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: b. Add collection access methods to MongoDB handler in src/database/mongodb.py
- Leverage: existing connection pooling, src/utils/logger.py
- Requirements: 1.2

## Instructions
- Implement ONLY task 6: "b. Add collection access methods to MongoDB handler in src/database/mongodb.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 6 --mode complete
```
