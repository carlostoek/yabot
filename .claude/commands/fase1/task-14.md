...
Execute task 14 for the fase1 specification.

## Task Description
Create event processor for handling subscriptions in src/events/processor.py

## Code Reuse
**Leverage existing code**: src/events/bus.py, src/utils/logger.py
...
Execute with @spec-task-executor agent the following task: "Create event processor for handling subscriptions in src/events/processor.py"

```
Use the @spec-task-executor agent to implement task 14: "Create event processor for handling subscriptions in src/events/processor.py" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create event processor for handling subscriptions in src/events/processor.py
- Leverage: src/events/bus.py, src/utils/logger.py
- Requirements: 2.3

## Instructions
- Implement ONLY task 14: "Create event processor for handling subscriptions in src/events/processor.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 14 --mode complete
```
