...
Execute task 44 for the fase1 specification.

## Task Description
Update README.md with infrastructure setup instructions

## Code Reuse
**Leverage existing code**: README.md (existing documentation patterns)
...
Execute with @spec-task-executor agent the following task: "Update README.md with infrastructure setup instructions"

```
Use the @spec-task-executor agent to implement task 44: "Update README.md with infrastructure setup instructions" for the fase1 specification and include all the below context.
...
## Task Details
- Task ID: 44
- Description: Update README.md with infrastructure setup instructions
- Leverage: README.md (existing documentation patterns)
- Requirements: Documentation

## Instructions
- Implement ONLY task 44: "Update README.md with infrastructure setup instructions"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks fase1 44 --mode complete
...
```bash
claude-code-spec-workflow get-tasks fase1 44 --mode complete
```
