...
Execute task 10 for the menu specification.

## Task Description
Add callback action routing in src/handlers/callback_processor.py

## Code Reuse
**Leverage existing code**: existing module patterns from src/modules/

## Requirements Reference
**Requirements**: REQ-MENU-002.2, REQ-MENU-007.1
...
Execute with @spec-task-executor agent the following task: "Add callback action routing in src/handlers/callback_processor.py"

```
Use the @spec-task-executor agent to implement task 10: "Add callback action routing in src/handlers/callback_processor.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Add callback action routing in src/handlers/callback_processor.py
- Leverage: existing module patterns from src/modules/
- Requirements: REQ-MENU-002.2, REQ-MENU-007.1

## Instructions
- Implement ONLY task 10: "Add callback action routing in src/handlers/callback_processor.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 10 --mode complete
```
