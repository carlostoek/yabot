...
Execute task 23 for the menu specification.

## Task Description
Register menu router with main application in src/core/application.py

## Code Reuse
**Leverage existing code**: existing application.py handler registration patterns

## Requirements Reference
**Requirements**: REQ-MENU-002.1
...
Execute with @spec-task-executor agent the following task: "Register menu router with main application in src/core/application.py"

```
Use the @spec-task-executor agent to implement task 23: "Register menu router with main application in src/core/application.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Register menu router with main application in src/core/application.py
- Leverage: existing application.py handler registration patterns
- Requirements: REQ-MENU-002.1

## Instructions
- Implement ONLY task 23: "Register menu router with main application in src/core/application.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 23 --mode complete
```
