...
Execute task 36 for the menu specification.

## Task Description
Create performance tests in tests/performance/test_menu_performance.py

## Code Reuse
**Leverage existing code**: tests/performance/ performance testing patterns
...
Execute with @spec-task-executor agent the following task: "Create performance tests in tests/performance/test_menu_performance.py"

```
Use the @spec-task-executor agent to implement task 36: "Create performance tests in tests/performance/test_menu_performance.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Create performance tests in tests/performance/test_menu_performance.py
- Leverage: tests/performance/ performance testing patterns
- Requirements: REQ-MENU-001.3, REQ-MENU-002.2

## Instructions
- Implement ONLY task 36: "Create performance tests in tests/performance/test_menu_performance.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 36 --mode complete
```
