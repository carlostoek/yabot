...
Execute task 34 for the menu specification.

## Task Description
Add async message cleanup optimization in src/ui/message_manager.py

## Code Reuse
**Leverage existing code**: asyncio patterns, APScheduler from existing modules

## Requirements Reference
**Requirements**: REQ-MENU-002.4
...
Execute with @spec-task-executor agent the following task: "Add async message cleanup optimization in src/ui/message_manager.py"

```
Use the @spec-task-executor agent to implement task 34: "Add async message cleanup optimization in src/ui/message_manager.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: Add async message cleanup optimization in src/ui/message_manager.py
- Leverage: asyncio patterns, APScheduler from existing modules
- Requirements: REQ-MENU-002.4

## Instructions
- Implement ONLY task 34: "Add async message cleanup optimization in src/ui/message_manager.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 34 --mode complete
```
