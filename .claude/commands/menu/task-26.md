...
Execute task 26 for the menu specification.

## Task Description
Add worthiness score explanation generation in src/services/user.py

## Code Reuse
**Leverage existing code**: src/ui/lucien

## Requirements Reference
**Requirements**: REQ-MENU-003.4, REQ-MENU-004.2
...
Execute with @spec-task-executor agent the following task: "Add worthiness score explanation generation in src/services/user.py"

```
Use the @spec-task-executor agent to implement task 26: "Add worthiness score explanation generation in src/services/user.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Add worthiness score explanation generation in src/services/user.py
- Leverage: src/ui/lucien
- Requirements: REQ-MENU-003.4, REQ-MENU-004.2

## Instructions
- Implement ONLY task 26: "Add worthiness score explanation generation in src/services/user.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 26 --mode complete
```
