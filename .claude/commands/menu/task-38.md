...
Execute task 38 for the menu specification.

## Task Description
Add system-level error handling in src/handlers/menu_system.py

## Code Reuse
**Leverage existing code**: src/shared/resilience/circuit

## Requirements Reference
**Requirements**: REQ-MENU-006.4
...
Execute with @spec-task-executor agent the following task: "Add system-level error handling in src/handlers/menu_system.py"

```
Use the @spec-task-executor agent to implement task 38: "Add system-level error handling in src/handlers/menu_system.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: Add system-level error handling in src/handlers/menu_system.py
- Leverage: src/shared/resilience/circuit
- Requirements: REQ-MENU-006.4

## Instructions
- Implement ONLY task 38: "Add system-level error handling in src/handlers/menu_system.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 38 --mode complete
```
