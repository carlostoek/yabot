...
Execute task 3 for the menu specification.

## Task Description
Add message cleanup scheduling in src/ui/message_manager.py

## Code Reuse
**Leverage existing code**: APScheduler patterns from src/modules/admin/post
...
Execute with @spec-task-executor agent the following task: "Add message cleanup scheduling in src/ui/message_manager.py"

```
Use the @spec-task-executor agent to implement task 3: "Add message cleanup scheduling in src/ui/message_manager.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Add message cleanup scheduling in src/ui/message_manager.py
- Leverage: APScheduler patterns from src/modules/admin/post
- Requirements: REQ-MENU-002.5

## Instructions
- Implement ONLY task 3: "Add message cleanup scheduling in src/ui/message_manager.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 3 --mode complete
```
