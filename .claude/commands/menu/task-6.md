...
Execute task 6 for the menu specification.

## Task Description
Integrate MenuFactory with message cleanup in src/handlers/menu_handler.py

## Code Reuse
**Leverage existing code**: src/ui/menu

## Requirements Reference
**Requirements**: REQ-MENU-006.1, REQ-MENU-006.2
...
Execute with @spec-task-executor agent the following task: "Integrate MenuFactory with message cleanup in src/handlers/menu_handler.py"

```
Use the @spec-task-executor agent to implement task 6: "Integrate MenuFactory with message cleanup in src/handlers/menu_handler.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Integrate MenuFactory with message cleanup in src/handlers/menu_handler.py
- Leverage: src/ui/menu
- Requirements: REQ-MENU-006.1, REQ-MENU-006.2

## Instructions
- Implement ONLY task 6: "Integrate MenuFactory with message cleanup in src/handlers/menu_handler.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 6 --mode complete
```
