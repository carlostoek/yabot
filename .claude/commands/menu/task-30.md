...
Execute task 30 for the menu specification.

## Task Description
Implement menu event publishers in src/events/menu_events.py

## Code Reuse
**Leverage existing code**: src/events/bus.py EventBus patterns

## Requirements Reference
**Requirements**: REQ-MENU-007.1, REQ-MENU-007.3
...
Execute with @spec-task-executor agent the following task: "Implement menu event publishers in src/events/menu_events.py"

```
Use the @spec-task-executor agent to implement task 30: "Implement menu event publishers in src/events/menu_events.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: Implement menu event publishers in src/events/menu_events.py
- Leverage: src/events/bus.py EventBus patterns
- Requirements: REQ-MENU-007.1, REQ-MENU-007.3

## Instructions
- Implement ONLY task 30: "Implement menu event publishers in src/events/menu_events.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 30 --mode complete
```
