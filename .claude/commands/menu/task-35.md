...
Execute task 35 for the menu specification.

## Task Description
Create performance monitoring for menu system in src/shared/monitoring/menu_performance.py

## Code Reuse
**Leverage existing code**: src/shared/monitoring/performance.py existing patterns

## Requirements Reference
**Requirements**: REQ-MENU-001.3, REQ-MENU-002.2
...
Execute with @spec-task-executor agent the following task: "Create performance monitoring for menu system in src/shared/monitoring/menu_performance.py"

```
Use the @spec-task-executor agent to implement task 35: "Create performance monitoring for menu system in src/shared/monitoring/menu_performance.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 35
- Description: Create performance monitoring for menu system in src/shared/monitoring/menu_performance.py
- Leverage: src/shared/monitoring/performance.py existing patterns
- Requirements: REQ-MENU-001.3, REQ-MENU-002.2

## Instructions
- Implement ONLY task 35: "Create performance monitoring for menu system in src/shared/monitoring/menu_performance.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 35 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 35 --mode complete
```
