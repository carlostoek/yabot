...
Execute task 27 for the menu specification.

## Task Description
Update menu factory integration with enhanced user context in src/ui/menu_factory.py

## Code Reuse
**Leverage existing code**: existing MenuFactory builders and organic menu patterns

## Requirements Reference
**Requirements**: REQ-MENU-003.5, REQ-MENU-004.5
...
Execute with @spec-task-executor agent the following task: "Update menu factory integration with enhanced user context in src/ui/menu_factory.py"

```
Use the @spec-task-executor agent to implement task 27: "Update menu factory integration with enhanced user context in src/ui/menu_factory.py" for the menu specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Update menu factory integration with enhanced user context in src/ui/menu_factory.py
- Leverage: existing MenuFactory builders and organic menu patterns
- Requirements: REQ-MENU-003.5, REQ-MENU-004.5

## Instructions
- Implement ONLY task 27: "Update menu factory integration with enhanced user context in src/ui/menu_factory.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks menu 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks menu 27 --mode complete
```
