...
Execute task 11 for the emocional specification.

## Task Description
Create detect_archetype_patterns method in src/modules/emotional/behavioral_analysis.py

## Code Reuse
**Leverage existing code**: MongoDB query patterns from src/services/narrative.py
...
Execute with @spec-task-executor agent the following task: "Create detect_archetype_patterns method in src/modules/emotional/behavioral_analysis.py"

```
Use the @spec-task-executor agent to implement task 11: "Create detect_archetype_patterns method in src/modules/emotional/behavioral_analysis.py" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: Create detect_archetype_patterns method in src/modules/emotional/behavioral_analysis.py
- Leverage: MongoDB query patterns from src/services/narrative.py
- Requirements: REQ-1

## Instructions
- Implement ONLY task 11: "Create detect_archetype_patterns method in src/modules/emotional/behavioral_analysis.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 11 --mode complete
```
