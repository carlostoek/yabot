...
Execute task 27 for the emocional specification.

## Task Description
Create get_personalized_content method in src/modules/emotional/intelligence_service.py

## Code Reuse
**Leverage existing code**: content coordination from src/services/cross
...
Execute with @spec-task-executor agent the following task: "Create get_personalized_content method in src/modules/emotional/intelligence_service.py"

```
Use the @spec-task-executor agent to implement task 27: "Create get_personalized_content method in src/modules/emotional/intelligence_service.py" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Create get_personalized_content method in src/modules/emotional/intelligence_service.py
- Leverage: content coordination from src/services/cross
- Requirements: REQ-3, REQ-4

## Instructions
- Implement ONLY task 27: "Create get_personalized_content method in src/modules/emotional/intelligence_service.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 27 --mode complete
```
