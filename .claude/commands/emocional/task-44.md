...
Execute task 44 for the emocional specification.

## Task Description
Create MongoDB emotional collections setup in src/database/migrations/emotional_collections.py

## Code Reuse
**Leverage existing code**: existing migration patterns from src/database/manager.py
...
Execute with @spec-task-executor agent the following task: "Create MongoDB emotional collections setup in src/database/migrations/emotional_collections.py"

```
Use the @spec-task-executor agent to implement task 44: "Create MongoDB emotional collections setup in src/database/migrations/emotional_collections.py" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 44
- Description: Create MongoDB emotional collections setup in src/database/migrations/emotional_collections.py
- Leverage: existing migration patterns from src/database/manager.py
- Requirements: Complete Integration

## Instructions
- Implement ONLY task 44: "Create MongoDB emotional collections setup in src/database/migrations/emotional_collections.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 44 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 44 --mode complete
```
