...
Execute task 36 for the emocional specification.

## Task Description
Add get_emotional_intelligence_service dependency in src/dependencies.py

## Code Reuse
**Leverage existing code**: existing service dependency patterns in src/dependencies.py
...
Execute with @spec-task-executor agent the following task: "Add get_emotional_intelligence_service dependency in src/dependencies.py"

```
Use the @spec-task-executor agent to implement task 36: "Add get_emotional_intelligence_service dependency in src/dependencies.py" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Add get_emotional_intelligence_service dependency in src/dependencies.py
- Leverage: existing service dependency patterns in src/dependencies.py
- Requirements: Complete Integration

## Instructions
- Implement ONLY task 36: "Add get_emotional_intelligence_service dependency in src/dependencies.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 36 --mode complete
```
