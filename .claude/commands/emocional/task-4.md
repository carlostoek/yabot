...
Execute task 4 for the emocional specification.

## Task Description
Add EmotionalJourney model to src/database/schemas/mongo.py User class
...
Execute with @spec-task-executor agent the following task: "Add EmotionalJourney model to src/database/schemas/mongo.py User class"

```
Use the @spec-task-executor agent to implement task 4: "Add EmotionalJourney model to src/database/schemas/mongo.py User class" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Add EmotionalJourney model to src/database/schemas/mongo.py User class
- Leverage: existing User model structure in src/database/schemas/mongo.py
- Requirements: REQ-2

## Instructions
- Implement ONLY task 4: "Add EmotionalJourney model to src/database/schemas/mongo.py User class"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 4 --mode complete
```
