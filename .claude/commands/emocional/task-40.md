...
Execute task 40 for the emocional specification.

## Task Description
Add handle_diana_level_progression method to src/services/cross_module.py

## Code Reuse
**Leverage existing code**: existing achievement coordination in src/services/cross

## Requirements Reference
**Requirements**: REQ-6, Complete Integration
...
Execute with @spec-task-executor agent the following task: "Add handle_diana_level_progression method to src/services/cross_module.py"

```
Use the @spec-task-executor agent to implement task 40: "Add handle_diana_level_progression method to src/services/cross_module.py" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 40
- Description: Add handle_diana_level_progression method to src/services/cross_module.py
- Leverage: existing achievement coordination in src/services/cross
- Requirements: REQ-6, Complete Integration

## Instructions
- Implement ONLY task 40: "Add handle_diana_level_progression method to src/services/cross_module.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 40 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 40 --mode complete
```
