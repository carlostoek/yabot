...
Execute task 42 for the emocional specification.

## Task Description
Create emotional besitos reward rules in src/modules/gamification/besitos_rewards/emotional_rewards.py

## Code Reuse
**Leverage existing code**: reward calculation from src/modules/gamification/besitos
...
Execute with @spec-task-executor agent the following task: "Create emotional besitos reward rules in src/modules/gamification/besitos_rewards/emotional_rewards.py"

```
Use the @spec-task-executor agent to implement task 42: "Create emotional besitos reward rules in src/modules/gamification/besitos_rewards/emotional_rewards.py" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 42
- Description: Create emotional besitos reward rules in src/modules/gamification/besitos_rewards/emotional_rewards.py
- Leverage: reward calculation from src/modules/gamification/besitos
- Requirements: REQ-6

## Instructions
- Implement ONLY task 42: "Create emotional besitos reward rules in src/modules/gamification/besitos_rewards/emotional_rewards.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 42 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 42 --mode complete
```
