...
Execute task 15 for the emocional specification.

## Task Description
Create retrieve_relevant_memories method in src/modules/emotional/memory_service.py

## Code Reuse
**Leverage existing code**: MongoDB query patterns from src/services/user.py
...
Execute with @spec-task-executor agent the following task: "Create retrieve_relevant_memories method in src/modules/emotional/memory_service.py"

```
Use the @spec-task-executor agent to implement task 15: "Create retrieve_relevant_memories method in src/modules/emotional/memory_service.py" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Create retrieve_relevant_memories method in src/modules/emotional/memory_service.py
- Leverage: MongoDB query patterns from src/services/user.py
- Requirements: REQ-4

## Instructions
- Implement ONLY task 15: "Create retrieve_relevant_memories method in src/modules/emotional/memory_service.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 15 --mode complete
```
