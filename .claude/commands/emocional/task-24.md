...
Execute task 24 for the emocional specification.

## Task Description
Create validate_vip_access method in src/modules/emotional/progression_manager.py

## Code Reuse
**Leverage existing code**: VIP validation from src/services/subscription.py
...
Execute with @spec-task-executor agent the following task: "Create validate_vip_access method in src/modules/emotional/progression_manager.py"

```
Use the @spec-task-executor agent to implement task 24: "Create validate_vip_access method in src/modules/emotional/progression_manager.py" for the emocional specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Create validate_vip_access method in src/modules/emotional/progression_manager.py
- Leverage: VIP validation from src/services/subscription.py
- Requirements: REQ-2, Complete Integration

## Instructions
- Implement ONLY task 24: "Create validate_vip_access method in src/modules/emotional/progression_manager.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks emocional 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks emocional 24 --mode complete
```
