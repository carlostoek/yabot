...
Execute task 11 for the ux-enhanced specification.

## Task Description
Update MainMenuBuilder to use Lucien voice generation in src/ui/menu_factory.py

## Code Reuse
**Leverage existing code**: existing MainMenuBuilder class, lucien
...
Execute with @spec-task-executor agent the following task: "Update MainMenuBuilder to use Lucien voice generation in src/ui/menu_factory.py"

```
Use the @spec-task-executor agent to implement task 11: "Update MainMenuBuilder to use Lucien voice generation in src/ui/menu_factory.py" for the ux-enhanced specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: Update MainMenuBuilder to use Lucien voice generation in src/ui/menu_factory.py
- Leverage: existing MainMenuBuilder class, lucien
- Requirements: Requirement 1.1, Requirement 1.5

## Instructions
- Implement ONLY task 11: "Update MainMenuBuilder to use Lucien voice generation in src/ui/menu_factory.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ux-enhanced 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ux-enhanced 11 --mode complete
```
