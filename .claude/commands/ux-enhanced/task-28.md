...
Execute task 28 for the ux-enhanced specification.

## Task Description
Create VIP upgrade journey tests in tests/integration/test_vip_upgrade_flows.py

## Code Reuse
**Leverage existing code**: existing test patterns, VIP management system

## Requirements Reference
**Requirements**: Requirement 2.2, Requirement 2.4
...
Execute with @spec-task-executor agent the following task: "Create VIP upgrade journey tests in tests/integration/test_vip_upgrade_flows.py"

```
Use the @spec-task-executor agent to implement task 28: "Create VIP upgrade journey tests in tests/integration/test_vip_upgrade_flows.py" for the ux-enhanced specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: Create VIP upgrade journey tests in tests/integration/test_vip_upgrade_flows.py
- Leverage: existing test patterns, VIP management system
- Requirements: Requirement 2.2, Requirement 2.4

## Instructions
- Implement ONLY task 28: "Create VIP upgrade journey tests in tests/integration/test_vip_upgrade_flows.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ux-enhanced 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ux-enhanced 28 --mode complete
```
