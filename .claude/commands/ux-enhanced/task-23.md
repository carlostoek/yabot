...
Execute task 23 for the ux-enhanced specification.

## Task Description
Create DIANA_ENCOUNTERS collection schema in src/database/schemas/mongo.py

## Code Reuse
**Leverage existing code**: existing MongoDB schema patterns, DianaSpecialMoment from task 7
...
Execute with @spec-task-executor agent the following task: "Create DIANA_ENCOUNTERS collection schema in src/database/schemas/mongo.py"

```
Use the @spec-task-executor agent to implement task 23: "Create DIANA_ENCOUNTERS collection schema in src/database/schemas/mongo.py" for the ux-enhanced specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Create DIANA_ENCOUNTERS collection schema in src/database/schemas/mongo.py
- Leverage: existing MongoDB schema patterns, DianaSpecialMoment from task 7
- Requirements: Requirement 3.2, Requirement 6.1

## Instructions
- Implement ONLY task 23: "Create DIANA_ENCOUNTERS collection schema in src/database/schemas/mongo.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ux-enhanced 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ux-enhanced 23 --mode complete
```
