...
Execute task 3 for the ux-enhanced specification.

## Task Description
Add Lucien personality constants to lucien_voice_generator.py

## Code Reuse
**Leverage existing code**: docs/narrativo/psicologia
...
Execute with @spec-task-executor agent the following task: "Add Lucien personality constants to lucien_voice_generator.py"

```
Use the @spec-task-executor agent to implement task 3: "Add Lucien personality constants to lucien_voice_generator.py" for the ux-enhanced specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Add Lucien personality constants to lucien_voice_generator.py
- Leverage: docs/narrativo/psicologia
- Requirements: Requirement 1.1

## Instructions
- Implement ONLY task 3: "Add Lucien personality constants to lucien_voice_generator.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ux-enhanced 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ux-enhanced 3 --mode complete
```
