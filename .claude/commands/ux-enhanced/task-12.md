...
Execute task 12 for the ux-enhanced specification.

## Task Description
Add role-based menu visibility with Lucien evaluation in src/ui/menu_factory.py

## Code Reuse
**Leverage existing code**: existing UserRole enum, Lucien voice generation system

## Requirements Reference
**Requirements**: Requirement 2.1, Requirement 2.4
...
Execute with @spec-task-executor agent the following task: "Add role-based menu visibility with Lucien evaluation in src/ui/menu_factory.py"

```
Use the @spec-task-executor agent to implement task 12: "Add role-based menu visibility with Lucien evaluation in src/ui/menu_factory.py" for the ux-enhanced specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Add role-based menu visibility with Lucien evaluation in src/ui/menu_factory.py
- Leverage: existing UserRole enum, Lucien voice generation system
- Requirements: Requirement 2.1, Requirement 2.4

## Instructions
- Implement ONLY task 12: "Add role-based menu visibility with Lucien evaluation in src/ui/menu_factory.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ux-enhanced 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ux-enhanced 12 --mode complete
```
