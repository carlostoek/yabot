...
Execute task 22 for the ux-enhanced specification.

## Task Description
Create LUCIEN_EVALUATIONS collection schema in src/database/schemas/mongo.py

## Code Reuse
**Leverage existing code**: existing MongoDB schema structure, database manager
...
Execute with @spec-task-executor agent the following task: "Create LUCIEN_EVALUATIONS collection schema in src/database/schemas/mongo.py"

```
Use the @spec-task-executor agent to implement task 22: "Create LUCIEN_EVALUATIONS collection schema in src/database/schemas/mongo.py" for the ux-enhanced specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create LUCIEN_EVALUATIONS collection schema in src/database/schemas/mongo.py
- Leverage: existing MongoDB schema structure, database manager
- Requirements: Requirement 1.2, Requirement 2.2

## Instructions
- Implement ONLY task 22: "Create LUCIEN_EVALUATIONS collection schema in src/database/schemas/mongo.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ux-enhanced 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ux-enhanced 22 --mode complete
```
