# conectar-todo - Task 25

Execute task 25 for the conectar-todo specification.

## Task Description
Add health check endpoints using ModuleRegistry in src/api/endpoints/health.py

## Code Reuse
**Leverage existing code**: src/shared/registry/module
...
## Usage
```
/Task:25-conectar-todo
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add health check endpoints using ModuleRegistry in src/api/endpoints/health.py"

```
Use the @spec-task-executor agent to implement task 25: "Add health check endpoints using ModuleRegistry in src/api/endpoints/health.py" for the conectar-todo specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Add health check endpoints using ModuleRegistry in src/api/endpoints/health.py
- Leverage: src/shared/registry/module
- Requirements: 6.5, 7.5

## Instructions
- Implement ONLY task 25: "Add health check endpoints using ModuleRegistry in src/api/endpoints/health.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks conectar-todo 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks conectar-todo 25 --mode complete
```
