# modulos-atomicos - Task 27

Execute task 27 for the modulos-atomicos specification.

## Task Description
Create circuit breaker service in src/shared/resilience/circuit_breaker.py

## Code Reuse
**Leverage existing code**: Redis state persistence

## Requirements Reference
**Requirements**: 5.3, 5.4, 7.8

## Usage
```
/Task:27-modulos-atomicos
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create circuit breaker service in src/shared/resilience/circuit_breaker.py"

```
Use the @spec-task-executor agent to implement task 27: "Create circuit breaker service in src/shared/resilience/circuit_breaker.py" for the modulos-atomicos specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Create circuit breaker service in src/shared/resilience/circuit_breaker.py
- Leverage: Redis state persistence
- Requirements: 5.3, 5.4, 7.8

## Instructions
- Implement ONLY task 27: "Create circuit breaker service in src/shared/resilience/circuit_breaker.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulos-atomicos 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulos-atomicos 27 --mode complete
```
