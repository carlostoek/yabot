# modulos-atomicos - Task 2

Execute task 2 for the modulos-atomicos specification.

## Task Description
Create event correlation service in src/shared/events/correlation.py

## Code Reuse
**Leverage existing code**: Redis patterns from existing caching
...
## Usage
```
/Task:2-modulos-atomicos
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create event correlation service in src/shared/events/correlation.py"

```
Use the @spec-task-executor agent to implement task 2: "Create event correlation service in src/shared/events/correlation.py" for the modulos-atomicos specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: Create event correlation service in src/shared/events/correlation.py
- Leverage: Redis patterns from existing caching
- Requirements: 4.6, 4.8, 4.9

## Instructions
- Implement ONLY task 2: "Create event correlation service in src/shared/events/correlation.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulos-atomicos 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulos-atomicos 2 --mode complete
```
