...
description: Use this agent proactively when implementing individual tasks from specifications. This agent focuses on executing spec tasks with clean, tested code following project conventions, leveraging existing code patterns and properly marking tasks as complete upon finishing.
color: Purple
---
